# Hi 👋 My name is Siebe Kylstra

## A full stack web developer with a business & data background

Started with a business degree, worked as a Business Intelligence Consultant with the Microsoft Stack (Power BI, SQL and Azure) and is now working as a Full Stack JS developer. I love solving puzzles in deployment, back-end and front-end (state management with Redux).
